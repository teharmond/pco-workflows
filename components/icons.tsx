...
export function Parable({
  ...
  return (
    ...
    >
      <g fill="none">
        <path
          d="M219.898 237.74V634.697H283.007C307.552 634.697 327.458 614.787 327.458 590.244V276.979C327.458 255.306 309.909 237.74 288.237 237.74H219.898Z"
          fill={fill}
        />
        <path
          d="M265.084 0.0488281C148.701 0.0488281 54.3266 94.2785 54.0859 210.614V634.696H117.195C141.755 634.696 161.646 614.787 161.646 590.243V211.031C161.646 153.906 207.959 107.609 265.084 107.609H340.528C415.668 107.609 477.349 167.943 478.022 243.067C478.938 342.029 413.344 387.073 352.431 387.073H292.708V494.636H352.431C419.328 494.636 479.901 467.812 522.942 419.142C563.942 372.796 586.259 309.816 585.585 242.12C584.236 107.754 473.692 0.0488281 339.309 0.0488281H265.084Z"
          fill={fill}
        />
      </g>
    </svg>
